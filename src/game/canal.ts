...
/**
 * Le relais, la confrontation d'equipes, et les trois autres jeux.
 *
 ...
 * presentent sur le canal de production. `/relay/*` est ouvert a qui fabrique
 * la requete, et c'est ce drapeau — cote client, a la compilation — qui decide
 * de qui VOIT le mode. Voir la note des trois portes dans worker/src/index.js.
 */
