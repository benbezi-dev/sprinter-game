...
(function () {
  ...
  const Audio_ = {
    ...
    build() {
      ...
      //
      // Deux choses arrivent ensemble quand une haie se deplie : le choc du
      ...
      //
      // Il vit ici, avec les autres bruitages, et pas dans le module du
      // passage : c'est ici que se trouvent le contexte audio, la coupure du
      // son et le reglage de volume. Un son fabrique ailleurs aurait fallu
      // reecrire les trois.
      //
    ...
    // posent l'une apres l'autre ont besoin de ces trois boutons — sans eux,
    // dix copies du meme echantillon a la meme hauteur, au meme volume et au
    // meme instant ne font pas une rangee de haies, elles font un bruit.
    sfx(name, reglages) {
