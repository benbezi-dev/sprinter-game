...
(function () {
  ...
  /* LES DEUX AIDES DE LA TOITURE, AU MEME NIVEAU QUE LE RESTE DU DECOR.
   *
   * Elles etaient declarees ENTRE l'en-tete de la boucle des panneaux
   * publicitaires et son corps, a l'interieur de drawWorld. Le jeu tournait
   * en developpement ; le build public, lui, ne trouvait plus rien —
   * « rangeeDeToiture is not defined » des la premiere image, la boucle de
   * rendu mourait sur l'exception et le jeu restait fige sur son ecran
   * d'ouverture. Un appel depuis un bloc qui ne les contient pas ne tient
   * que sur la tolerance d'un mode non strict, et un module n'en a pas.
   */
  /**
   * Les positions d'une rangee d'objets le long du toit, espacees en METRES.
   *
