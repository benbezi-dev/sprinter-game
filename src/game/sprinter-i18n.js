...
(function (root) {
  ...
  const UI = {
    ...
    champ_course_ecrite: ['le résultat est enregistré au championnat',
                          'the result has been recorded in the championship'],
    champ_absent:    ['pas encore là', 'not here yet'],
    champ_attente:   ['il manque {n} coureur(s) sur la piste',
                      '{n} runner(s) still missing on the track'],
    champ_retour:    ['revenir au championnat', 'back to the championship'],
    champ_camera_on: ['CAMÉRA ALLUMÉE', 'CAMERA ON'],
    champ_camera_off: ['ALLUMER LA CAMÉRA', 'TURN THE CAMERA ON'],
    champ_camera_refus: ['la caméra a été refusée', 'the camera was refused'],
    champ_chat_titre: ['LE CHAT DE LA COURSE', 'RACE CHAT'],
    champ_chat_vide: ['personne n’a encore rien dit', 'nobody has said anything yet'],
    champ_chat_placeholder: ['dis quelque chose', 'say something'],
    // le salon des championnats — réservé aux organisateurs
    salon_titre:     ['SALON DES CHAMPIONNATS', 'CHAMPIONSHIPS ROOM'],
    salon_prochain_samedi: ['PROCHAIN SAMEDI', 'NEXT SATURDAY'],
    salon_deplier:   ['voir le monde — {n} zone(s) prête(s)', 'see the world — {n} zone(s) ready'],
    salon_replier:   ['replier le salon', 'fold the room back'],
    salon_nations:   ['NATIONS', 'NATIONS'],
    salon_continents: ['CONTINENTS', 'CONTINENTS'],
    salon_monde:     ['MONDE', 'WORLD'],
    salon_en_cours:  ['ÉDITIONS EN COURS', 'EDITIONS UNDER WAY'],
    salon_partants:  ['{n} partants', '{n} runners'],
    salon_courses:   ['{n} série(s)', '{n} heat(s)'],
    salon_reduit:    ['1re ÉDITION — FORMAT RÉDUIT', '1ST EDITION — REDUCED FORMAT'],
    salon_ouvrir_cycle: ['OUVRIR LE CYCLE — {n} ZONES', 'OPEN THE CYCLE — {n} ZONES'],
    salon_ouvrir_zone: ['ouvrir', 'open'],
    salon_cloturer:  ['clôturer la phase', 'close the phase'],
    salon_saisir:    ['saisir un chrono', 'enter a time'],
    salon_enregistrer: ['ENREGISTRER LA COURSE', 'RECORD THE RACE'],
    salon_fermer:    ['fermer', 'close'],
    salon_chrono_vide: ['abandon', 'no time'],
    salon_course_vide: ['aucun partant dans cette course', 'nobody in this heat'],
    salon_aucune_nation: ['aucun pays n’a encore assez de joueurs',
                          'no country has enough players yet'],
    salon_cycle_ouvert: ['le cycle est ouvert', 'the cycle is open'],
    salon_zone_ouverte: ['{z} est ouverte', '{z} is open'],
    salon_phase_close: ['la phase est clôturée', 'the phase is closed'],
