...
(function (root) {
  ...
  const UI = {
    ...
    champ_pistolet:     ['Pistolet dans {d}', 'Gun in {d}'],
    ...
    champ_regle_appel:  ['Qui n’est pas là 30 s avant le pistolet est forfait.',
                         'Anyone not here 30 s before the gun is a no-show.'],
