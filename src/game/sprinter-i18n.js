...
(function (root) {
  ...
  const UI = {
    ...
    // tutoriel
    tuto_step:       ['ÉTAPE {n} SUR {t}', 'STEP {n} OF {t}'],
    tuto_1_t:        ['ALTERNE', 'ALTERNATE'],
    tuto_1_s:        ['une touche, puis l’autre. Jamais deux fois le même pied — sinon tu trébuches.',
                      'one button, then the other. Never the same foot twice — or you stumble.'],
    tuto_same_foot:  ['DEUX FOIS LE MÊME PIED', 'SAME FOOT TWICE'],
    tuto_2_t:        ['LE SIGNAL', 'THE GUN'],
    tuto_2_s:        ['touche dès le coup de pistolet, pas avant. Plus tu es proche, plus tu pars vite.',
                      'tap on the gun, not before. The closer you are, the faster you leave.'],
    tuto_slow:       ['trop tard : le bonus de départ est perdu', 'too late: the start bonus is gone'],
    tuto_3_t:        ['MONTE LA CADENCE', 'BUILD YOUR CADENCE'],
    tuto_3_s:        ['deux ou trois appuis larges pour lancer la machine, puis installe une cadence rapide et tiens-la. C’est le passage de l’un à l’autre qui paie — marteler dès le départ ne vaut rien.',
                      'two or three wide presses to get going, then settle into a fast cadence and hold it. It is the shift between the two that pays — hammering from the start is worth nothing.'],
    tuto_press_left: ['encore {n} appuis', '{n} presses to go'],
    tuto_ratio:      ['accélération ×{r}   ·   cadence finale {c} ms',
                      'speed-up ×{r}   ·   final cadence {c} ms'],
    tuto_hint_slow:  ['tu as bien accéléré, mais la cadence n’a jamais tenu sous 125 ms. Installe-toi plus tôt dans le rythme rapide, au lieu de descendre progressivement.',
                      'you did speed up, but the cadence never held under 125 ms. Settle into the fast rhythm sooner instead of easing down gradually.'],
    tuto_hint_flat:  ['cadence constante : il n’y a aucune accélération à récompenser. Commence par deux ou trois appuis plus larges.',
                      'flat cadence: there is no speed-up to reward. Begin with two or three wider presses.'],
    tuto_hint_good:  ['bien joué. Élargis encore les premiers appuis, ou serre un peu plus la cadence, pour viser la transition parfaite.',
                      'well done. Widen the first presses further, or tighten the cadence a little more, to reach the perfect transition.'],
    tuto_hint_perfect:['c’est exactement ça. En course, ça vaut une vitesse de pointe plus haute jusqu’à l’arrivée.',
                      'that is exactly it. In a race this buys you a higher top speed all the way home.'],
    tuto_again:      ['REESSAYER', 'TRY AGAIN'],
    tuto_next:       ['CONTINUER', 'CONTINUE'],
    tuto_done_t:     ['À TOI DE COURIR', 'YOUR TURN'],
    tuto_done_s:     ['La poussée dure {d} mètres, le corps se redresse jusqu’à {t}. Après, il n’y a plus qu’à tenir.',
                      'The drive lasts {d} metres, the body straightens until {t}. After that, just hold on.'],
    tuto_start:      ['COMMENCER', 'START'],
    tuto_replay:     ['revoir le tutoriel', 'watch again'],
    tuto_skip:       ['passer le tutoriel', 'skip the tutorial'],
